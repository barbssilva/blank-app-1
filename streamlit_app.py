...
faturas_input = st.text_input(
    "🧾(Opcional) Indique a(s) fatura(s) ou data de envioa - (isto é apenas usado para o nome do ficheiro excel que irá descarregar no fim. ATENÇÃO - se escrever uma data não use /):"
)
